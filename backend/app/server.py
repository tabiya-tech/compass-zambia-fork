...
if not os.getenv('ZAMBIA_MONGODB_URI'):
    raise ValueError("Mandatory ZAMBIA_MONGODB_URI env variable is not set!")
...
async def lifespan(_app: FastAPI):
    ...
    zambia_jobs_db = await CompassDBProvider.get_zambia_jobs_db()
