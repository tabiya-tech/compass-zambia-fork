  ...
  return (
    <Suspense fallback={<Backdrop isShown={true} transparent={true} />}>
      ...
      >
        ...
        >
          <PageHeader title="home.modules.skillsDiscovery" subtitle="home.modules.skillsDiscoverySubtitle" />
          <Box
            sx={{
              paddingY: isMobile ? theme.spacing(theme.tabiyaSpacing.xs) : theme.spacing(theme.tabiyaSpacing.md),
