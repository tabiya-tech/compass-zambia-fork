...
export const DATA_TEST_ID = {
  ...
  ERROR_CHAT_MESSAGE_BRAND_LOGO: `error-chat-message-brand-logo-${uniqueId}`,
};
...
const ErrorChatMessage: React.FC<ErrorChatMessageProps> = ({ message, children }) => {
  return (
    <div
      data-testid={DATA_TEST_ID.ERROR_CHAT_MESSAGE_CONTAINER}
      style={{
        display: "flex",
        flexDirection: "row",
        alignItems: "center",
    ...
    >
      <Box data-testid={DATA_TEST_ID.ERROR_CHAT_MESSAGE_BRAND_LOGO}>
        <BrandLogo />
      </Box>
