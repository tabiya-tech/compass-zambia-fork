...
from prepare_admin_frontend import deployments_dir
...
def _make_bucket_public(basic_config: ProjectBaseConfig, bucket_name: pulumi.Output,
    ...
    gcp.storage.BucketIAMMember(
        get_resource_name(resource="admin-all-users-object-viewer", resource_type="bucket-membership"),
        bucket=bucket_name,
...
def deploy_admin_frontend(*,
    ...
    bucket = _create_bucket(basic_config, "admin-frontend")

    admin_frontend_artifacts_dir = os.path.join(deployments_dir, artifacts_dir)
